...
const events = [
  ...
  },
  {
    ...
    description: (
      <p>
        Join us for an exciting social mixer with Northeastern Electric Racing,
        where you can look forward to a fun-filled evening of activities, such
        as Human Bingo and more, and delicious catering. A perfect opportunity
  ...
  },
  {
    ...
    description: (
      <p>
        Want to learn App Development? Join us for an engaging workshop where
